...
Within the application specifically the icons that have been built the color sceme is follows: Alpha Conversation-Red, New/Debug/Navigation/GHC-Blue, Fix Point-Green, Local-Purple and Unfold/Inline/Fold-Yellow. With naming of these icon images need to make sure that it is completely lowercase and only use letters and numbers. For spacing need to use "_" in between different words in the title.
