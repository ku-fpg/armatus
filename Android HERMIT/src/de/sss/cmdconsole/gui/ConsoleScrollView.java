...
/**
 * Derived a class from ScrollView just to get the current scrolled position at
 * onScrollChanged since ScrollView itself does not provide public method for
 * one to get it.
 */
