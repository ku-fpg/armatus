 ...
 */
package de.sss.cmdconsole.common;
...
public class CFunc {
	...
	public static String int2Ipv4(int netAddr) {
		...
		sb.append(netAddr & 0xff).append(".").append((netAddr >> 8) & 0xff)
				.append(".").append((netAddr >> 16) & 0xff).append(".")
				.append((netAddr >> 24) & 0xff);
		return sb.toString();
	}

	public static String int2Ipv4(byte[] netAddr) {
		int addr = (netAddr[3] << 24) | (netAddr[2] << 16) | (netAddr[1] << 8)
				| (netAddr[0]);
