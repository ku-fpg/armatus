...
public class History implements Parcelable {
	...
	public static Parcelable.Creator<History> CREATOR =
		...
		public History createFromParcel(Parcel source) {
			ImmutableList<HistoryCommand> commands = ParcelUtils.readImmutableTypedList(source, HistoryCommand.CREATOR);
			List<HistoryTag> tags = ParcelUtils.readImmutableTypedList(source, HistoryTag.CREATOR);
