 ...
 * @param <A> The <code>Activity</code> class being managed.
 */
public class BaseApplication<A extends Activity> extends Application {
	 ...
	 * simultaneously, so use a {@link ListMultimap} to connect an <code>Activity</code>'s name
	 ...
	 * completed execution.
	 * @param activity The {@link Activity} that spawned the <code>AsyncActivityTask</code>.
	 * @param task The <code>AsyncActivityTask</code> to remove.
	 */
	 ...
	 * @param activity The <code>Activity</code> that spawned the <code>AsyncActivityTask</code>.
	 * @param task The <code>AsyncActivityTask</code> to connect.
	 */
	 ...
	 * </code> method from one of its {@link AsyncActivityTask AsyncActivityTasks} can produce
	 * unexpected results. Use this method to set all of an <code>Activity</code>'s references
	 * in its tasks to <code>null</code> so that the tasks can work around rotation or standby.
	 * @param activity The <code>Activity</code> whose references should be set to null.
	 */
	 ...
	 * AsyncActivityTasks} after the <code>Activity</code> is resumed.
	 * @param activity The <code>Activity</code> whose references should be reestablished.
	 */
